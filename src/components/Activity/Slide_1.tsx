...
export default function Slide_1() {
  ...
  const [containerHeight, setContainerHeight] = createSignal("calc(100vh - 140px)");
  ...
  return (
    <div class="w-full h-full flex flex-col items-center justify-center px-4 py-6" 
        ...
        <div class="mb-8">
          ...
          <div class="relative">
            ...
            <Show when={showDatePicker()}>
              <div class="absolute mt-1 w-full bg-white rounded-lg border border-gray-200 shadow-lg z-40">
                <DatePicker
