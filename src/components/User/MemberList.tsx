  ...
  return (
    <div class="member-list flex flex-col items-center w-full max-w-3xl mx-auto bg-white rounded-xl shadow-lg p-6 md:p-8">
                  ...
                  >
                    ...
                    <div class="flex items-center">
                      ...
                      <svg 
                        ...
                        class={`h-5 w-5 text-white transition-transform duration-200 ${isTeamExpanded(team.id) ? 'transform rotate-180' : ''}`}
                        viewBox="0 0 20 20" 
                        fill="currentColor"
                      >
                        <path 
      ...
      >
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-8 animate-pulse w-full">
